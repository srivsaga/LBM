	...
	Integer, parameter:: Xmax=41,Ymax=41
...
c***********************************************************
	...
	INTEGER ph,Xmax,Ymax,x,y,xr,xl,yt,yb,s
...
c***********************************************************
	...
	INTEGER ph,Xmax,Ymax,x,y,s,yt,xr,yb,xl	
	LOGICAL wall(Xmax,Ymax)
...
c	rho(s,x,y)=1.0-exp(rho(s,x,y)/D0)
	ELSE
	rho(s,x,y)=0.0
	ENDIF
	ENDDO
...
c     &     +rho(1,xl,yb)/1.414)))
	...
	Fx(1,x,y)=-rho(1,x,y)*G12*((rho(2,xr,y)+rho(2,xr,yt)
     &     +rho(2,xr,yb)-(rho(2,xl,y)+rho(2,xl,yt)
     &     +rho(2,xl,yb))))
	Fx(2,x,y)=-rho(2,x,y)*G12*((rho(1,xr,y)+rho(1,xr,yt)
     &     +rho(1,xr,yb)-(rho(1,xl,y)+rho(1,xl,yt)
     &     +rho(1,xl,yb))))
	Fy(1,x,y)=-rho(1,x,y)*G12*(rho(2,x,yt)+rho(2,xr,yt)
     &     +rho(2,xl,yt)-(rho(2,x,yb)+rho(2,xr,yb)
     &     +rho(2,xl,yb)))
	Fy(2,x,y)=-rho(2,x,y)*G12*((rho(1,x,yt)+rho(1,xr,yt)
     &     +rho(1,xl,yt)-(rho(1,x,yb)+rho(1,xr,yb)
     &     +rho(1,xl,yb))))
